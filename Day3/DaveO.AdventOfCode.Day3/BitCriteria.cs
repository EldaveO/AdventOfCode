...
namespace DaveO.AdventOfCode.Day3
{
    class BitCriteria
    {
        ...
        public static List<Rate> O2KickOut(List<Rate> rates, int ones, int zeros, string type, int position)
        {
        ...
        public static List<Rate> CO2KickOut(List<Rate> rates, int ones, int zeros, string type, int position)
        {
            var tempRates = new List<Rate>(rates);
